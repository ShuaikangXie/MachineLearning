...
class KNearestNeighbor(object):
    ...
    def compute_distances_no_loops(self, X):
        ...
        #########################################################################
        # Vector quantization , Boardcast mechanism calculation matrix
        # -2*a*b
        # 0 manipulates columns,1 manipulates rows
        dists = np.multiply(np.dot(X,self.X_train.T),-2)
        # a^2,Keep the two-dimensional properties of the matrix
